...
"""
llm = init_chat_model(model="gpt-5.4-mini", temperature=0.2)
...
def create_kb():
    ...
    doc = Document(page_content=KNOWLEDGE_BASE, metadata={"source": "langchain_knowledge_base.py"})
...
Answer (include sources):"""
    ...
    answer = rag_chain.invoke("What are the core compenents of LangChain?")
